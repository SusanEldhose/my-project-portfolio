...
Development of a handheld spectral sensing system to measure leaf reflectance across the 350–850 nm spectral range. The device is intended to support the assessment of plant health, nutrient status, and stress conditions based on the spectral characteristics of leaves.
